...
public class HttpMethod {
     ...
     * @param subscriber
     */
    public void getTuijian(Subscriber<Tuijian> subscriber) {
        service.getTuijian(Config.KEY, "15")
     ...
     * @param subscriber
     */
    public void getSports(Subscriber<Sports> subscriber) {
        service.getSports(Config.KEY, "15")
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(subscriber);
    }
     ...
     * @param subscriber
     */
    public void getPicture(Subscriber<Picture> subscriber) {
        service.getPicture(Config.KEY, "15")
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(subscriber);
    }
